    ...
    <div>
      ...
      <div className='flex flex-wrap'>
        <div className='w-4/12 mb-5'>
          <div className='mx-3 border rounded bg-pink-500 h-[160px] flex items-center justify-center'>
        ...
        <div className='w-4/12 mb-5'>
          <div className='mx-3 border rounded bg-yellow-600 h-[160px] flex items-center justify-center'>
            <div className='text-center'>
        ...
        <div className='w-4/12 mb-5'>
          <div className='mx-3 border rounded bg-emerald-600 h-[160px] flex items-center justify-center'>
            <div className='text-center'>
